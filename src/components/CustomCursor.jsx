...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      <div
        ref={spotlightRef}
        className="fixed top-0 left-0 w-[700px] h-[700px] rounded-full pointer-events-none z-[9998] opacity-0 blur-[110px] transition-opacity duration-300"
        style={{
          background: 'radial-gradient(circle, rgba(75,114,232,0.2) 0%, rgba(56,189,248,0.08) 40%, transparent 75%)'
        }}
      ></div>
      ...
      <div
        ref={dotRef}
        className="fixed top-0 left-0 z-[99999] pointer-events-none w-3 h-3 bg-[#4B72E8] rounded-full shadow-[0_0_15px_#4B72E8]"
      ></div>

      {/* Global Custom Cursor Ring */}
      <div
        ref={ringRef}
        className="fixed top-0 left-0 z-[99999] pointer-events-none w-12 h-12 border border-[#4B72E8]/60 rounded-full flex items-center justify-center backdrop-blur-[1px]"
      ></div>
    </>
  );
};
